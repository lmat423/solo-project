  ...
  <section>
    ...
    <table width="1100" align="center" cellspacing="0" id="firsttable">
     ...
     <c:forEach items="${plist}" var="pvo">  
      <tr>
        <td colspan="2" id="ptitle"> ${pvo.writeday}(${pvo.yoil}) 도착예정(상품 1개) </td>
      </tr>
      <tr>
        <td width="100" id="pcontent"> <img src="/static/pro/${pvo.pimg}" width="80"> </td>
        <td id="pcontent">  
           <div> ${pvo.title} </div>
           <div> <fmt:formatNumber value="${pvo.price}"/>원 <span id="chg">(할인율 : ${pvo.halin}%) </span> </div>
           <div> 수량 ${pvo.su}개 </div>
        </td>
      </tr>
    ...
    <table width="1100" align="center" id="secondtable" cellspacing="0">
      ...
      <tr>
        ...
        <td width="260"> ${bvo.name} / ${bvo.phone} </td>
        <td width="120"> </td>
